...
public interface IGuiTile
{
    ...
    default boolean openGui(EntityPlayer player, Object currentGui, Object... data)
    {
        ...
        {
            player.openGui(Loader.instance().getIndexedModList().get(((ITile) this).modID()), getDefaultGuiID(player), ((ITile) this).world().unwrap(), ((ITile) this).xi(), ((ITile) this).yi(), ((ITile) this).zi());
            return true;
        }
        return false;
    }
